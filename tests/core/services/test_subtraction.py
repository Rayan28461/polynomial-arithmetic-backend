...
from src.core.services.addition import subtraction as sub
...
class TestSub:
    def test_sub_binary_small_m_successful(
        ...
        result = sub(poly1=poly1, poly2=poly2, input_type=input_type, m=m_small)
    ...
    def test_sub_binary_large_m_successful(
        ...
        result = sub(poly1=poly1, poly2=poly2, input_type=input_type, m=m_large)
    ...
    def test_sub_invalid_bin_input(
        ...
        with pytest.raises(ValueError):
            ...
            sub(poly1=poly1, poly2=poly2, input_type=input_type, m=m_small)
