from src.core.services.subtraction import subtraction as sub
...
expectedOutput1 = int("00001111", 2)
...
expectedOutput2 = int("111" + ("0" * 159) + "1", 2)
...
expectedOutput4 = int("4" + ("00" * 19) + "01", 16)
