...
def testMod():
    ...
    expectedOutput = '0' *163
    if subTest == expectedOutput : print("Reducing the input Works")
    else: print("Reducing the input fails")
