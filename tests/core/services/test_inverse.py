...
class TestInverse:
    def test_inverse_binary_small_m_successful(
        ...
        result = inverse(poly=poly, input_type=input_type, m=m_small)
    ...
    def test_inverse_binary_large_m_successful(
        ...
        result = inverse(poly=poly, input_type=input_type, m=m_large)
        assert result == int(
    ...
    def test_inverse_invalid_bin_input(
        ...
        with pytest.raises(ValueError):
            ...
            inverse(poly=poly, input_type=input_type, m=m_small)
